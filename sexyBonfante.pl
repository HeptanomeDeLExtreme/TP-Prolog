...
testUtil1 :-
	...
	(Reponse =:= 2 -> ( afficherFin('incrementeX', true, 'TEST REUSSI'), incrementerTestsReussis) ;
	( afficherFin('incrementeX', false, 'TEST ECHOUE'), incrementerTestsEchoues )).
	
testUtil2 :-
	afficherNomTest(testUtil2),
	afficherDebut('decrementeX', true, 'Decrementation d une variable'),
	decrementeX(3, Reponse),!,
	(Reponse =:= 2 -> ( afficherFin('decrementeX', true, 'TEST REUSSI'), incrementerTestsReussis);
	( afficherFin('decrementeX', false, 'TEST ECHOUE'), incrementerTestsEchoues )).
